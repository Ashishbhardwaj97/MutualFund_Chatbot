...
### 1. Corpus Definition
- **Selected AMC**: ICICI Prudential Asset Management Company (using Groww as the product context)
- **Currently Selected URLs (10 Schemes)**:
...
- **Answer facts-only queries**, such as:
  ...
  - Benchmark index
  - Fund size (AUM) of a scheme
  - Fund management details (e.g., fund manager names, tenure, and experience)
  - Process to download statements or capital gains reports
- **Ensure constraints are met**:
  - Each response is limited to a maximum of **3 sentences**
  - Each response includes **exactly one citation link**
  - Each response includes a footer in this format:
